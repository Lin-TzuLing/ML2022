...
class myModel(nn.Module):
    def __init__(self, input_dim, output_dim, zipcode_dim=30):
...
model = myModel(input_dim=n_feature, output_dim=1, zipcode_dim=10)
...
if __name__ == '__main__':
    ...
    pred_test = trainModel(epochs=370, batch_size=128, lr=0.001)
